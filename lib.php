 ...
 * @return void
 */
function local_reactdemo_extend_navigation_course($navigation, $course, $context) {
    $url  = new moodle_url('/local/reactdemo/index.php', ['courseid' => $course->id, 'contextid' => $context->id]);
